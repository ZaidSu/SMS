SMS_PARENT_LAYOUT.init("classes");
(function() {
  ...
  SMS_API.getClasses(child.branchId).then(function(allClasses) {
    ...
    document.getElementById("page-content").innerHTML =
      SMS_UI.pageHeader({title:"Classes",subtitle:SMS_UI.esc(child.fullName)+"'s enrolled classes and schedule",breadcrumb:["Parent Portal","Classes"]})+
