SMS_STUDENT_LAYOUT.init("messages");
(function() {
  ...
  SMS_API.getMessages(user.id).then(function(messages) {
    document.getElementById("page-content").innerHTML =
      SMS_UI.pageHeader({title:"Messages",subtitle:"Communicate with teachers and administration",breadcrumb:["Student Portal","Messages"],
