SMS_STUDENT_LAYOUT.init("attendance");
(function() {
  ...
  Promise.all([SMS_API.getAttendance({studentId:child.id}),SMS_API.getClasses(child.branchId)]).then(function(res){
    ...
    document.getElementById("page-content").innerHTML=[
      SMS_UI.pageHeader({title:"Attendance",subtitle:SMS_UI.esc(child.fullName)+"'s attendance record",breadcrumb:["Student Portal","Attendance"]}),
